...
// Host portal PMH ID (hostname bỏ qua port). Mở QLTS TỪ portal (đã đăng nhập SSO) thì phải
// vào THẲNG, không bắt gõ email lại. Phải khớp host trong PMH_ISSUER_URL (.env).
const PORTAL_HOST = 'de-admin.pmh.com.vn';
/**
