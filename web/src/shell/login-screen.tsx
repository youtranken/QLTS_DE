...
/**
 * Màn đăng nhập (chưa có phiên) — nền hologram 3D (laptop xoay) + 1 card kính ở giữa,
 * 1 ô nhập duy nhất. Email → chuyển PMH ID (kèm login_hint để điền sẵn; đã có phiên IdP
 * thì vào thẳng). KHÔNG phải email → hiện ô mật khẩu và thử SA cục bộ (break-glass): BE
 * trả lỗi CHUNG cho sai-tên/sai-mật-khẩu nên không lộ tồn tại tài khoản SA. loginForbidden
 * = bị chặn group (10.2) → lối thoát duy nhất là đổi tài khoản.
 */
