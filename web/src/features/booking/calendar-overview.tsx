                ...
                >
                  ...
                  {machines.map((m, mi) => (
                    <div key={`row-${m.id}`} style={{ display: 'contents' }}>
                      <div
                        className="mcal-mcell"
                        style={{ gridColumn: 1, gridRow: mi + 2 }}
                        title={
                          m.software
              ...
              {free.map((m) => (
                ...
                >
                  <div className="fc-main">
                    ...
                    <span className="fc-spec">{m.type}</span>
                  </div>
                ...
                {boardRows.map((r) => {
                  const cls = r.isOverdue
                    ...
                    : r.state === 'in_use'
                      ...
                      : r.state === 'awaiting_pickup'
                        ? 'warn'
                        : 'muted';
                  // Tới hạn trả trong hôm nay (chưa quá hạn) → badge nhắc + mail đã gửi đúng giờ.
                  const dueToday =
                    !r.isOverdue &&
                    r.state === 'in_use' &&
                    r.due != null &&
                    new Date(r.due).toDateString() === new Date().toDateString();
                  ...
                  return (
                    <tr
                      key={r.ticketId}
                      className={
                        r.isOverdue ? 'overdue' : dueToday ? 'due-today' : undefined
                      }
                    >
                      <td>
                      ...
                      <td className={dueToday ? 'due-soon' : undefined}>
                        {fmtDate(r.due)}
                      </td>
                      <td>
                        ...
                        {dueToday && (
                          <span className="badge warn" style={{ marginLeft: 6 }}>
                            {t('board.dueToday', 'Tới hạn hôm nay')}
                          </span>
                        )}
