...
export class BookingController {
  ...
  /** Các ngày máy đã bận trong [from,to) — FE khóa ngày trùng trên DatePicker (AD-5: chỉ ngày). */
  @Get('machines/:id/busy-dates')
  busyDates(
    @Param('id', ParseUUIDPipe) id: string,
    @Query() query: AvailabilityQueryDto,
  ) {
    return this.booking.busyDates(id, query.from, query.to);
  }
